...
class OceanoGeometry(Geometry):
   def __init__(self, width=1, height=1, position=(0, 0), alignment=(0.5, 0.5)):
        ...
        p01 = [x + (0.5 - a) * width, y + (-0.5-b) * height, 0]
        ...
        # texture coordinates
        t0, t01, t1, t2, t3 = [0, 0], [0.5, -0.5], [1, 0], [0, 1], [1, 1]
        position_data = [p0, p1, p3, p0, p3, p2, p0, p01, p1]
        color_data = [c0, c1, c3, c0, c3, c2]
        uv_data = [t0, t1, t3, t0, t3, t2, t0, t01, t1]
